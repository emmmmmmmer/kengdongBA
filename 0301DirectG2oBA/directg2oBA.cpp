...
// global variables
string pose_file = "/home/lu/code/0301DirectG2oBA/rgbd_dataset_freiburg1_rpy_results.txt";      //VO       切三份  滑窗 40+10
string points_file = "/home/lu/code/ch5/cmake-build-debug/fr1rpy.txt";        //改成具体的路径就可以         //3D
...
int main(int argc, char **argv) {
    ...
    boost::format fmt("/home/lu/code/ch5/color/%d.png");
    for (int i = 0; i < 798; i++) {
    ...
    optimizer.optimize(1);        //迭代次数       int 的lambda值不好缩小    88
