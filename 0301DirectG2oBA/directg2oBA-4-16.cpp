...
// global variables
string pose_file = "/home/lu/code/0301DirectG2oBA/pose_rgb11.txt";
string points_file = "/home/lu/code/0301DirectG2oBA/points2.txt";        //改成具体的路径就可以
...
int main(int argc, char **argv) {
    ...
    for (size_t i = 0; i < poses_number; i++) {
        ...
        std::cout<< std::fixed << std::showpoint <<t[0]<<" "<<t[1]<<" "<<t[2]<<" "<<quat.x()<<" "<<quat.y()<<" "<<quat.z()<<" "<<quat.z()<<endl;
